...
* Oppgave 6:Her har jeg kopiert kode fra kompendiumet. Jeg setter riktig foreldre node og passer på at jeg håndterer null tilfeller. Jeg gjenbruker denne fjern koden i de andre metodene i denne oppgaven.I fjernAlle traverserer i nivåOrden og fjerner noden om verdien matcher. I fjern alle bruker jeg nivåTraversering igjen og gjenbruker koden fra de anre metodene og fjerner en og en node om gangen.
